...
SELECT * FROM Interval_Table PARTITION(SYS_P1724);
SELECT * FROM Interval_Table PARTITION(SYS_P1725);

SELECT * FROM Hash_Table PARTITION(SYS_P1721);
SELECT * FROM Hash_Table PARTITION(SYS_P1722);
SELECT * FROM Hash_Table PARTITION(SYS_P1723);
